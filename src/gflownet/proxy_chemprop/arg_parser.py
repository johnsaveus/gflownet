...
def ready_parser():
    ...
    parser.add_argument("--aggregation", type=str, help="Aggregation function", default="mean")
    parser.add_argument("--hidden_dim_readout", type=int, help="Hidden dim for readout", default=128)
    parser.add_argument("--hidden_layers_readout", type=int, help="Hidden layers for readout", default=1)
    ...
    parser.add_argument("--init_lr", type=float, help="Initial learning rate", default=1e-3)
    parser.add_argument("--max_lr", type=float, help="Max learning rate", default=1e-2)
    parser.add_argument("--final_lr", type=float, help="Final learning rate", default=1e-4)
    return parser
