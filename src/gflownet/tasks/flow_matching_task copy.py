...
from gflownet.proxy.model import load_proxy_to_gflow_sol


class FlowMatchingTask(GFNTask):
...
class SEHFragTrainer(StandardOnlineTrainer):
    ...
    def set_default_hps(self, cfg: Config):
        ...
        cfg.cond.temperature.dist_params = [4]
...
def main():
    ...
    config.log_dir = "./logs/fm_experiment(lr=1e-3)"
    seed = 42
    wandb.login()
